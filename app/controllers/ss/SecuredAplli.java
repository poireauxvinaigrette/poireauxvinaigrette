...
import views.html.ss.index;
import views.html.ss.linkResult;


/**
 * A sample controller
 */
public class SecuredAplli extends Controller {
     ...
     * @param env
     */
    public SecuredAplli(RuntimeEnvironment env) {
        this.env = env;
    }
    /**
